...
change_graph('2018_12_31', '367552070', 'Difference')
plt.title('CHARLES HUAN, Allision - 12/31/2018 (Change in Angle Difference)')
plt.savefig('graphics/charleshuan/charleshuan_anglediff_scatter_change.png', bbox_inches='tight')
plt.clf()

change_graph('2022_01_06', '367103180', 'Difference')
plt.title('JACKSON PLATTE, Allision - 01/06/2022 (Change in Angle Difference)')
plt.savefig('graphics/jacksonplatte/jacksonplatte_anglediff_scatter_change.png', bbox_inches='tight')
plt.clf()

change_graph('2021_01_07', '477288000', 'Difference')
plt.title('OCEAN PRINCESS, Allision - 01/07/2021 (Change in Angle Difference)')
plt.savefig('graphics/oceanprincess/oceanprincess_anglediff_scatter_change.png', bbox_inches='tight')
plt.clf()

change_graph('2019_01_14', '367638020', 'Difference')
plt.title('RANDY ECKSTEIN, Allision - 01/14/2019 (Change in Angle Difference)')
plt.savefig('graphics/randyeckstein/randyeckstein_anglediff_scatter_change.png', bbox_inches='tight')
plt.clf()

change_graph('2021_04_10', '338257000', 'Difference')
plt.title('BROOKS MCCALL, Allision - 04/10/2021 (Change in Angle Difference)')
plt.savefig('graphics/brooksmccall/brooksmccall_anglediff_scatter_change.png', bbox_inches='tight')
plt.clf()

change_graph('2021_06_10', '367781550', 'Difference')
plt.title('GARLAND GASPARD, Allision - 06/10/2021 (Change in Angle Difference)')
plt.savefig('graphics/garlandgaspard/garlandgaspard_anglediff_scatter_change.png', bbox_inches='tight')
plt.clf()

change_graph('2023_03_22', '368236120', 'Difference')
plt.title('JAMES E JACKSON, Allision - 03/21/2023 (Change in Angle Difference)')
plt.savefig('graphics/jamesejackson/jamesejackson_anglediff_scatter_change.png', bbox_inches='tight')
plt.clf()

change_graph('2022_01_24', '366946840', 'Difference')
plt.title('MEAGHAN MARIE, Allision - 01/24/2022 (Change in Angle Difference)')
plt.savefig('graphics/meaghanmarie/meaghanmarie_anglediff_scatter_change.png', bbox_inches='tight')
plt.clf()

change_graph('2021_08_17', '368142750', 'Difference')
plt.title('NYQUIST, Allision - 08/17/2021 (Change in Angle Difference)')
plt.savefig('graphics/nyquist/nyquist_anglediff_scatter_change.png', bbox_inches='tight')
plt.clf()

change_graph('2019_01_08', '366995430', 'Difference')
plt.title('ZEUS, Allision - 01/08/2019 (Change in Angle Difference)')
plt.savefig('graphics/zeus/zeus_anglediff_scatter_change.png', bbox_inches='tight')
plt.clf()